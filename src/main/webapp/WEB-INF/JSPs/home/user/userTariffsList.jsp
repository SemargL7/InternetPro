    ...
    <div class="container-fluid w-75 p-3">
        ...
        <table class="table table-light">
            ...
            <tr>
                ...
                <th id="thPaidStatus" scope="col">Paid Status</th>
            ...
            <c:forEach var="tariff" items="${userTariff}">
                <tr>
                    ...
                    <td style="font-size: large;"><a class="btn btn-outline-dark" title="Disconnect" href="/home/disconnectTariff?id=<c:out value='${tariff.id}' />">⇍</a>
                </tr>
            </c:forEach>
            </tbody>
        </table>
