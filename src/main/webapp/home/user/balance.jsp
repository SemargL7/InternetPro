...
<main class="mt-1">
    <div class="container-fluid w-75 p-3 text-light d-flex justify-content-center">
        <form class="p-3 bg-dark rounded" action="/home/depositBalance" method="post">
            <h1 id="depositLogo">Deposit</h1>
            <div class="form-group p-1">
                <label id="inputMoneyLabel" for="inputMoney">The amount of replenishment</label>
                <input type="number" class="form-control" id="inputMoney" placeholder="money" name="balance" min="0" required>
            </div>
            <button type="submit" class="btn btn-primary ms-1" id="depositSubmitBtn">Submit</button>
        </form>
    </div>
</main>
