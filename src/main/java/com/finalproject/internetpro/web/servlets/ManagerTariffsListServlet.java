...
public class ManagerTariffsListServlet extends HttpServlet {
    private static final Logger logger = Logger.getLogger(ManagerTariffsListServlet.class);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = req.getRequestDispatcher(Path.PAGE__MANAGER_TARIFF_LIST);
